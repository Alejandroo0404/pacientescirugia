...
const ModalCirujanoCargo = ({setModalOnCirujanoCargo,setChoiceCirujanoCargo}) => {
  const handleCancelarClick = () => {
    //setChoice(false)
    //setModalOn(false)
    setModalOnCirujanoCargo(false)
    setChoiceCirujanoCargo(false)
}
  return (
...
export default ModalCirujanoCargo