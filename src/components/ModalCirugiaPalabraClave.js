...
const ModalCirugiaPalabraClave = ({setChoiceCirugiaPalabraClave,setModalOnCirugiaPalabraClave}) => {
    const handleCancelarClick = () => {
        setChoiceCirugiaPalabraClave(false)
        setModalOnCirugiaPalabraClave(false)
        ...
        <div
          ...
          <div
            ...
            <h5 className="text-xl font-medium leading-normal text-gray-800" id="exampleModalScrollableLabel">
              Lista de Selección de Resultados
            </h5>
            <button type="button"
...
export default ModalCirugiaPalabraClave